...
Autor: Rodrigo Pires
Script: Código da classe FetchDataGraficoTemperatura.java
Data: 2 de março de 2021
*/

public class FetchDataGraficoTemperatura extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            jsonArray = object.getJSONArray("tempStat");
