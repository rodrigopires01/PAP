...
Autor: Rodrigo Pires
Script: Código da classe GraficoPeso.java
Data: 2 de março de 2021
*/

public class GraficoPeso extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FetchDataGraficoPeso process = new FetchDataGraficoPeso();
        ...
        int length = FetchDataGraficoPeso.jsonArray.length();

        teste = String.valueOf(FetchDataGraficoPeso.jsonArray);

        System.out.println(teste + " grafico");

        for(int i = 0; i < length; i++){
            try {
                double valor = FetchDataGraficoPeso.jsonArray.getDouble(i);
                array[i] = FetchDataGraficoPeso.jsonArray.getDouble(i);
